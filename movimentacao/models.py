...
class Movimentacao(models.Model):
    ...
    imposto_renda = models.BooleanField(default=False, verbose_name="Imposto de Renda [Sim/Não]", choices=[
        (True, 'Sim'),
        (False, 'Não'), 
    ])
    ...
    cadastrada_por = models.ForeignKey(User, on_delete=models.PROTECT, verbose_name='Cadastrado Por')
